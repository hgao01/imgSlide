package com.sanfrancisco.galleryswitch;
...
public class MainActivity extends Activity implements ViewFactory {
    ...
    private OnItemClickListener galListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
            ...
            //Toast.makeText(MainActivity.this, "Your choice image #：" + (position + 1),Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private void buildViews() {
        Gallery gal = (Gallery) findViewById(R.id.glIdPhoto);  //deprecated
    ...
    public View makeView() {
        ...
        //v.setBackgroundColor(0xFF000000);  //by me
